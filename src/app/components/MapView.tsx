                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">Stop #{stop.id}</p>
                      </div>
        ...
        <div className="flex-1 relative">
          ...
          <div className="absolute bottom-6 right-6 bg-white rounded-xl shadow-lg p-4 z-[1000]">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-center gap-2">
                <div className="w-8 h-0.5 bg-blue-600" style={{ borderTop: "3px dashed #3B82F6" }}></div>
          ...
          {/* Selected Stop Info */}
          {selectedStop && (
            <div className="absolute top-6 left-6 bg-white rounded-xl shadow-lg p-6 z-[1000] max-w-sm">
              <div className="flex items-start justify-between mb-3">
                <h3 className="font-bold text-xl text-gray-900">{selectedStop.name}</h3>
                <button
              ...
              <p className="text-sm text-gray-600 mb-3">Stop #{selectedStop.id} on the tour route</p>
